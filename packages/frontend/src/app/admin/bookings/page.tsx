...
export default function AdminBookingsPage() {
    ...
    const fetchBookings = useCallback(async () => {
        ...
        if (dbError) {
            ...
            setError(
                'Не удалось загрузить бронирования. Пожалуйста, попробуйте снова.',
            );
        } else if (data) {
    ...
    const getCarImagePath = (carName: string, carImageUrl?: string) => {
        ...
        if (formattedName.includes('w223') || formattedName.includes('s580'))
            return '/cars/w223.jpg';
                                    ...
                                    <div className="relative">
                                        ...
                                        >
                                            <option value="created_at_desc">
                                                Новые сначала (по созданию)
                                            </option>
                                            <option value="created_at_asc">
                                                Старые сначала (по созданию)
                                            </option>
                                            <option value="date_from_desc">
                                                Новые сначала (по дате аренды)
                                            </option>
                                            <option value="date_from_asc">
                                                Старые сначала (по дате аренды)
                                            </option>
                                        </select>
                            ...
                            <div className="text-center py-20 px-6 bg-neutral-800/30 border border-neutral-700 rounded-lg">
                                ...
                                <p className="text-neutral-400">
                                    {searchTerm
                                        ...
                                        : 'Как только появятся новые бронирования, они будут отображены здесь.'}
                                </p>
                            </div>
                        ) : (
