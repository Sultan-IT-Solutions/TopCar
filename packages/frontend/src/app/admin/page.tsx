    ...
    const adminNavItems: AdminNavItem[] = [
        {
            ...
            description:
                'Просмотр, поиск и управление всеми заявками на аренду.',
            href: '/admin/bookings',
            Icon: TicketIcon,
        ...
        },
        {
            ...
            description:
                'Добавление, редактирование и удаление автомобилей из каталога.',
            href: '/admin/cars',
            Icon: TruckIcon,
                               ...
                               shadow-xl hover:shadow-2xl transform hover:-translate-y-1 transition-all duration-300 ease-in-out`}
                                    >
                                        <div className="flex items-start gap-4">
                                            <div
                                                className={`flex-shrink-0 p-3 rounded-lg bg-black/30 border border-neutral-600 group-hover:border-[#d4af37]/50`}
                                            >
                                                <item.Icon
                                                    className={`h-8 w-8 ${item.textColorClass} group-hover:text-[#d4af37] transition-colors`}
                                                />
                                            </div>
                                            <div>
