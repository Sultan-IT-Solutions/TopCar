...
export default function ContactPage() {
  ...
  const handleContactSubmit = async (e: FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      if (!response.ok) {
        throw new Error(result.message || 'Ошибка при отправке данных в CRM.');
      }
      ...
      setFormStatus({ type: 'error', message: 'Не удалось отправить заявку. Пожалуйста, попробуйте снова.' });
