                    ...
                    <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6">
                        <FadeInWhenVisible>
                            ...
                            <h1 className="text-4xl sm:text-5xl md:text-6xl font-extrabold tracking-tight text-white">
                                Приложение{' '}
                                <span className="text-[#d4af37]">TopCar</span>
                            </h1>
                            <p className="mt-5 sm:mt-6 text-lg sm:text-xl text-neutral-300 max-w-2xl mx-auto leading-relaxed">
                                Установите наше прогрессивное веб-приложение
                                (PWA) на главный экран вашего устройства для
                                максимального удобства и эксклюзивных
                                преимуществ.
                            </p>
                    ...
                    <div className="max-w-5xl mx-auto">
                        <div className="grid md:grid-cols-2 gap-12 lg:gap-16 items-center">
                            ...
                            <FadeInWhenVisible className="w-full">
                                <div
                                    className="relative aspect-[9/16] sm:aspect-square md:aspect-[9/16] bg-neutral-800/60 rounded-2xl shadow-2xl 
                                ...
                                <div className="space-y-8">
                                    ...
                                    <div className="bg-neutral-900 border border-neutral-700/80 rounded-xl p-6 space-y-4">
                                        ...
                                        <p className="text-sm text-neutral-300 leading-relaxed">
                                            1. Откройте этот сайт в вашем
                                            мобильном браузере (Chrome, Safari и
                                            др.).
                                            <br />
                                            2. Нажмите на иконку{' '}
                                        ...
                                        <p className="text-xs text-neutral-500">
                                            После установки TopCar появится
                                            среди ваших приложений для быстрого
                                            доступа.
                                        </p>
                                    </div>
                                    ...
                                    <div className="bg-gradient-to-r from-[#d4af37]/20 via-neutral-900 to-neutral-900 border border-[#d4af37]/50 rounded-xl p-6 text-center">
                                        ...
                                        <p className="text-sm text-neutral-400 mb-3">
                                            Здесь появится ваше персональное
                                            предложение. Больше просматривайте
                                            наш сайт, чтобы получить его!
                                        </p>
                                    </div>
