...
const documents = [
    {
        name: 'Лицензия на осуществление деятельности',
                ...
                <section className="py-16 sm:py-20 px-4 sm:px-6">
                    <div className="max-w-4xl mx-auto">
                        <h1 className="text-4xl sm:text-5xl font-extrabold mb-8 text-center tracking-tight">
                            Безопасность и{' '}
                            <span className="text-[#d4af37]">документы</span>
                        ...
                        <p className="text-lg text-neutral-400 mb-16 text-center max-w-2xl mx-auto">
                            Мы работаем полностью официально и прозрачно. Здесь
                            вы можете ознакомиться с нашими ключевыми
                            документами, подтверждающими нашу надежность и
                        ...
                        <div className="space-y-4">
                            {documents.map((doc, index) => (
                                <div
                                    key={index}
                                    className="bg-neutral-900 border border-neutral-700 rounded-xl p-5 flex items-center justify-between gap-4"
                                >
