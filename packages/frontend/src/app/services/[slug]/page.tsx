...
const servicesData: {
    ...
    'arenda-s-voditelem': {
        ...
        content:
            'Наша услуга аренды автомобиля с водителем идеально подходит для деловых поездок, специальных мероприятий или просто для тех, кто ценит свое время и комфорт. Наши водители - это опытные профессионалы, знающие город и готовые обеспечить вашу безопасность на дороге.',
    },
    'transfer-v-aeroport': {
        title: 'Трансфер в аэропорт',
        description: 'Пунктуальная и комфортная доставка в аэропорт и из него.',
        content:
            'Мы предлагаем надежные трансферы в/из международного аэропорта Алматы. Встретим вас или ваших гостей с табличкой, поможем с багажом и обеспечим быструю и комфортную поездку до места назначения на автомобиле премиум-класса.',
    },
    'arenda-na-meropriyatiya': {
        ...
        content:
            'Свадьбы, юбилеи, корпоративные вечера или фотосессии — наши автомобили станут украшением любого события. Мы предлагаем гибкие условия аренды для мероприятий любого масштаба.',
    },
};
            ...
            <AnimatedPageWrapper>
                ...
                <main className="container mx-auto px-4 py-24 text-center">
                    ...
                    <p className="text-muted-foreground mt-4">
                        К сожалению, мы не смогли найти запрашиваемую вами
                        услугу.
                    </p>
                </main>
                <Footer />
