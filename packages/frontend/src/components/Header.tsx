...
export default function Header() {
    ...
    const handleLogin = useCallback(
        () => handleAction(() => setShowLoginModal(true)),
        [handleAction],
    );
    const openCalcModal = useCallback(
        () => handleAction(() => setShowCalcModal(true)),
        [handleAction],
    );
                ...
                <div className="container mx-auto px-4 flex justify-between items-center h-20 relative">
                    ...
                    <div className="flex items-center gap-2">
                        ...
                        <button
                            ...
                            aria-label={
                                isMenuOpen
                                    ? t('common.close') + ' ' + t('common.menu')
                                    : t('common.open') + ' ' + t('common.menu')
                            }
