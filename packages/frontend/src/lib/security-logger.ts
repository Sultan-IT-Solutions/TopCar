...
class SecurityLogger {
   ...
   */
  logValidationError(field: string, error: string, metadata?: Record<string, any>): void {
    this.log(
   ...
   */
  logWebhookSignatureInvalid(source: string, metadata?: Record<string, any>): void {
    this.log(
   ...
   */
  getLogsBySeverity(severity: SecurityEventSeverity, limit = 100): SecurityEvent[] {
